...
async def nexus_search_private_channels(
    workspace_id: str,
    name: str,
    response_format: Optional[str] = None,
) -> str:
    """
    Search private channels in a workspace by name.

    Args:
        workspace_id: required; string; Nexus workspace ID.
        name: required; string; Channel name to search for.
    ...
    return await call_tool('nexus_search_private_channels', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_search_private_channels...")
        try:
            result = await nexus_search_private_channels(
