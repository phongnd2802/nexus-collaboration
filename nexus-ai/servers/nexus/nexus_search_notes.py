...
async def nexus_search_notes(
    ...
    Args:
        ...
        mode: optional; string; Search mode.
    ...
    return await call_tool('nexus_search_notes', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_search_notes...")
        try:
            result = await nexus_search_notes(
