...
async def nexus_list_channels(
    workspace_id: str,
    response_format: Optional[str] = None,
) -> str:
    """
    List channels in a workspace that the authenticated user can access.
    ...
    return await call_tool('nexus_list_channels', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_list_channels...")
        try:
            result = await nexus_list_channels(
