...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_update_note...")
        ...
        try:
            result = await nexus_update_note(
