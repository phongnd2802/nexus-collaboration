...
async def nexus_get_workspace_members(
    workspace_id: str,
    response_format: Optional[str] = None,
) -> str:
    """
    List members of a Nexus workspace.
    ...
    return await call_tool('nexus_get_workspace_members', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_get_workspace_members...")
        try:
            result = await nexus_get_workspace_members(
