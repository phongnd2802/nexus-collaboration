...
async def nexus_cancel_scheduled_message(
    workspace_id: str,
    ...
    return await call_tool('nexus_cancel_scheduled_message', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_cancel_scheduled_message...")
        ...
        try:
            result = await nexus_cancel_scheduled_message(
