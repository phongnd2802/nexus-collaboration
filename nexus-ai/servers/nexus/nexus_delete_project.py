...
async def nexus_delete_project(
    workspace_id: str,
    project_id: str,
    ...
    return await call_tool('nexus_delete_project', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_delete_project...")
        ...
        try:
            result = await nexus_delete_project(
