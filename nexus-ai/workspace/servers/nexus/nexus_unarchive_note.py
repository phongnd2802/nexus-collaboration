...
async def nexus_unarchive_note(
    workspace_id: str,
    note_id: str,
    response_format: Optional[str] = None,
) -> str:
    """
    Unarchive a note and all its sub-notes.
    ...
    return await call_tool('nexus_unarchive_note', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_unarchive_note...")
        ...
        try:
            result = await nexus_unarchive_note(
