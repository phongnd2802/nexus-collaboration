...
async def nexus_get_channel_messages(
    workspace_id: str,
    channel_id: str,
    ...
    """
    Get channel messages with limit and offset pagination.
    ...
    return await call_tool('nexus_get_channel_messages', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_get_channel_messages...")
        try:
            result = await nexus_get_channel_messages(
