...
async def nexus_bookmark_message(
    workspace_id: str,
    message_id: str,
    response_format: Optional[str] = None,
) -> str:
    """
    Bookmark a message in a channel or conversation.
    ...
    return await call_tool('nexus_bookmark_message', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_bookmark_message...")
        ...
        try:
            result = await nexus_bookmark_message(
