...
async def nexus_get_workspace(
    workspace_id: str,
    response_format: Optional[str] = None,
) -> str:
    """
    Get details for a Nexus workspace by ID.
    ...
    return await call_tool('nexus_get_workspace', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_get_workspace...")
        try:
            result = await nexus_get_workspace(
