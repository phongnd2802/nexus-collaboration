...
async def nexus_get_project_members(
    workspace_id: str,
    project_id: str,
    ...
    return await call_tool('nexus_get_project_members', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_get_project_members...")
        try:
            result = await nexus_get_project_members(
