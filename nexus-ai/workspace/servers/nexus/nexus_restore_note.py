...
async def nexus_restore_note(
    workspace_id: str,
    note_id: str,
    response_format: Optional[str] = None,
) -> str:
    """
    Restore a soft-deleted note and all its sub-notes.
    ...
    return await call_tool('nexus_restore_note', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_restore_note...")
        ...
        try:
            result = await nexus_restore_note(
