...
async def nexus_get_channel_unread_count(
    workspace_id: str,
    channel_id: str,
    ...
    return await call_tool('nexus_get_channel_unread_count', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_get_channel_unread_count...")
        try:
            result = await nexus_get_channel_unread_count(
