...
async def nexus_get_scheduled_message(
    workspace_id: str,
    scheduled_message_id: str,
    response_format: Optional[str] = None,
) -> str:
    """
    Get details for a scheduled message by ID.
    ...
    return await call_tool('nexus_get_scheduled_message', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_get_scheduled_message...")
        try:
            result = await nexus_get_scheduled_message(
