...
async def nexus_update_project(
    workspace_id: str,
    project_id: str,
    ...
    Args:
        ...
        owner_id: optional; string; Owner user ID.
        ...
        kanban_stages: optional; array; Updated kanban stages.
        attachments: optional; object; Updated note, file, and event links.
        collaborative_data: optional; object; Updated collaborative metadata.
    ...
    return await call_tool('nexus_update_project', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_update_project...")
        ...
        try:
            result = await nexus_update_project(
