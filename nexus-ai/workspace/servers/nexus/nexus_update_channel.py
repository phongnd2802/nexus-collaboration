...
async def nexus_update_channel(
    workspace_id: str,
    channel_id: str,
    ...
    Args:
        ...
        name: optional; string; Channel name.
        description: optional; string; Channel description.
        is_private: optional; boolean; Whether this channel is private.
        member_ids: optional; array; User IDs to set as members for private channels.
    ...
    return await call_tool('nexus_update_channel', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_update_channel...")
        ...
        try:
            result = await nexus_update_channel(
