...
async def nexus_delete_note(
    workspace_id: str,
    note_id: str,
    response_format: Optional[str] = None,
) -> str:
    """
    Soft delete a note and all its sub-notes.
    ...
    return await call_tool('nexus_delete_note', arguments)
...
if __name__ == "__main__":
    ...
    async def test() -> None:
        print("Testing nexus_delete_note...")
        ...
        try:
            result = await nexus_delete_note(
