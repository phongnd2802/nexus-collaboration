...
-- CreateEnum
CREATE TYPE "ProjectRole" AS ENUM ('ADMIN', 'EDITOR', 'MEMBER');
...
CREATE TABLE "UserSettings" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "autoAcceptTaskAssignments" BOOLEAN NOT NULL DEFAULT true,
    "taskReminderNotifications" BOOLEAN NOT NULL DEFAULT true,
    "showDueDatesInLocalTimezone" BOOLEAN NOT NULL DEFAULT true,
    "emailProjectInvitations" BOOLEAN NOT NULL DEFAULT true,
    "emailTaskAssignments" BOOLEAN NOT NULL DEFAULT true,
    "emailTaskDueDateReminders" BOOLEAN NOT NULL DEFAULT true,
    "emailComments" BOOLEAN NOT NULL DEFAULT true,
    "inAppProjectUpdates" BOOLEAN NOT NULL DEFAULT true,
    "inAppRoleChanges" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "File" (
    ...
    "taskId" TEXT,
    "projectId" TEXT NOT NULL,
    "isTaskDeliverable" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE UNIQUE INDEX "VerificationToken_id_code_key" ON "VerificationToken"("id", "code");
