...
export const schema = {
  ...
  /**
   * Stores Slack workspace installations for the Nexus Whiteboard app
  ...
  /**
   * Links Nexus whiteboards to Slack
  ...
  /**
   * Maps Slack users to Nexus users
   * Created when user opens whiteboard from Slack for the first time
   */
  slack_user_mappings: {
    columns: [
      { name: 'id', type: 'uuid', primaryKey: true, default: 'gen_random_uuid()' },
      { name: 'deskive_user_id', type: 'string', nullable: false }, // Nexus user ID
  ...
  /**
   * Links Nexus workspaces to Slack channels for calendar notifications
