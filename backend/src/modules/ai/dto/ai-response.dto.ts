...
export class AIVideoResponse {
  @ApiProperty({ description: 'Generated video URL' })
  video_url: string;

  @ApiPropertyOptional({ description: 'Video thumbnail URL' })
  thumbnail_url?: string;

  @ApiProperty({ description: 'Video specifications' })
  specifications: {
    duration: number;
    aspect_ratio: string;
    frame_rate: number;
...
export class AIVideoJobStatusResponse {
  @ApiProperty({ description: 'Video generation task ID' })
  task_id: string;

  @ApiProperty({ description: 'Current status of video generation' })
  status: string;

  @ApiPropertyOptional({ description: 'Generated video URL (when completed)' })
  video_url?: string;
  ...
  @ApiPropertyOptional({ description: 'File size in bytes (when completed)' })
  file_size?: number;

  @ApiPropertyOptional({ description: 'Video duration in seconds (when completed)' })
  duration?: number;
}
